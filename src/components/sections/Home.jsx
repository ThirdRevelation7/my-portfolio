            ...
            <RevealOnScroll>
                ...
                <div className="text-center z-10 px-4">
                    ...
                    <div className="flex justify-center space-x-4">
                        <a
                            href="#projects"
                            className="bg-pink-500 text-white py-3 px-6 rounded font-medium transition-all overflow-hidden relative duration-400 ease-in-out hover:shadow-[0_0_15px_theme('colors.pink.400')] hover:bg-pink-500/5 hover:animate-pulse hover:-translate-y-1.5"
