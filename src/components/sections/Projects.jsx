            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            <h3 className="text-xl font-bold mb-2 text-left">Business Website</h3>
                        ...
                        >
                            <h3 className="text-xl font-bold mb-2 text-left">Flask/Python/SQL fan website</h3>
                            <p className="text-gray-400 mb-4 text-left">
                            ...
                            <div className="flex justify-between items-center">
                                <a href="https://youtu.be/jRdbYlCWoUA" className="text-cyan-200 hover:text-cyan-100">
                                    View Project →
                                </a>
